...
/** 分页获取公告 分页获取公告 POST /api/notice/getNoticeList */
export async function getNoticeListUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getNoticeListUsingPOSTParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePageNotice_>('/api/notice/getNoticeList', {
    method: 'POST',
    params: {
      ...params,
    },
