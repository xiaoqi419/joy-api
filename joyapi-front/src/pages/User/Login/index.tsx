...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (values: API.UserInfoItem) => {
    console.log(values)
      ...
      >
        <LoginForm
          ...
          onFinish={async values => {
            await handleSubmit(values as API.UserInfoItem)
          }}
        >
          <Tabs
            activeKey={type}
              ...
              <ProFormText
                ...
                rules={[
                  ...
                  },
                  {
                    ...
                    max: 20,
                    message: (
                      <FormattedMessage id="pages.login.account.length" />
                    )
                  }
                ]}
              />
